...
base= base.dropna(axis=0) # registros com valores faltantes são apagados

# Retiramos da base de dados vendas na NA e EU com valores menores que 1
